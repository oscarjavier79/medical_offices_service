...
public class Response400 {
      ...
      @ApiModelProperty(example = "INVALID_REQUEST", name = "errorCode", dataType = "string", position = 5)
      private String errorCode;

      @ApiModelProperty(example = "Invalid request", name = "message", dataType = "string", position = 6)
